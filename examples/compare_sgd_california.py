...
# Linear Regression Stochastic Gradient Descent from Scratch 
...
print("Linear Regression Stochastic Gradient Descent from Scratch")
...
comparison["Absolute Difference"] = (
    comparison["Scratch Linear Regression SGD"] - comparison["Scikit-learn"]
).abs()
