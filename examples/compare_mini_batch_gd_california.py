...
# Linear Regression Mini Batch Gradient Descent from Scratch 
my_model = LinearRegressionMiniBatchGD(
                                lr=0.01,
                                max_iter=1000,
                                batch_size = 32,
                                shuffle=True,
...
print("Linear Regression Mini Batch Gradient Descent from Scratch")
...
comparison = pd.DataFrame({
    ...
    "Scratch Linear Regression Mini Batch GD": [
...
comparison["Absolute Difference"] = (
    comparison["Scratch Linear Regression Mini Batch GD"] - comparison["Scikit-learn"]
).abs()
